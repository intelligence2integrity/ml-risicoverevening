...
#'            verschil versie 16/17: MVV feature eruit
#'            verschil versie 17/39: alle fkgs eruit
#'            verschil versie 39/40: versie 40 is identiek aan versie 39 met voor elke parameter als default de beste
#'            waarde gevonden voor 30/10/2020 17:00 uur
########################################################################################################################
...
i2i_features <- c("aantal_diag"    , "aantal_fkg_01"  , "aantal_fkg_02"  , "aantal_fkg_03"  , "aantal_fkg_04"  ,  
                  "aantal_fkg_05"  , "aantal_fkg_06"  , "aantal_fkg_07"  , "aantal_fkg_08"  , "aantal_fkg_09"  , 
                  "aantal_fkg_10"  , "aantal_fkg_11"  , "aantal_fkg_12"  , "aantal_fkg_13"  , "aantal_fkg_14"  ,  
                  "aantal_fkg_16"  , "aantal_fkg_17"  , "aantal_fkg_18"  , "aantal_fkg_19"  , "aantal_fkg_20"  ,  
                  "aantal_fkg_21"  , "aantal_fkg_22"  , "aantal_fkg_23"  , "aantal_fkg_24"  , "aantal_fkg_25"  ,  
                  "aantal_fkg_26"  , "aantal_fkg_27"  , "aantal_fkg_28"  , "aantal_fkg_29"  , "aantal_fkg_30"  ,  
                  "aantal_fkg_31"  , "aantal_fkg_32"  , "aantal_fkg_33"  , "aantal_fkg_34"  , "aantal_fkg_35"  ,  
                  "aantal_fkg_36"  , "aantal_fkg_37"  , "aantal_spec"    , "aantal_zp"      , "avinw"          ,
                  "dx_groep_101018", "dx_groep_101072", "dx_groep_101150", "dx_groep_101171", "dx_groep_102019",
                  ...
                  "dx_groep_93049" , "dx_groep_93050" , "dx_groep_93051" , "fdg"            , "hkg"            ,
                  "leeftijd2"      , "lgnw"           ,
                  "mhk"            , "n_operatief"    , "n_verpleeg"     , "pdkg"           , "ppanw"          ,
                  "regsom"         , "sdkg"           , "sesnw"   )
...
i2i_train <- function(train_set, boost_track_length=12, colsample_bytree=0.9, eta=0.41, 
                      feature_importance_name='imp_xgb_v040.txt', gamma=1, nsd=0, max_min_child_weight=24,
                      max_number_of_trees=84, subsample=0.632, totaal_induur_cap=1, verbose){
