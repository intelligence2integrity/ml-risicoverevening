...
########################################################################################################################
#' Bestandsnaam: VWS_Gupta_i2i_ML_ols_vxxx.R
...
source(file.path(root_dir, 'src', 'utils', 'VWS_Gupta_i2i_ML_utils_v002.R'))
...
prepareer_data <- function(dt_set, bevat_gew_target){
  ...
  feats = c('lgnw', 'regsom', 'avinw', 'sesnw', 'ppanw', 'pdkg', 'sdkg', 'fkg00', 'fkg01', 'fkg02', 'fkg03',
...
i2i_train <- function(train_set){
  ...
  one_hot_feats <- colnames(dt_train[, -c('target', 'gew')])
  constraint_cols <- list(one_hot_feats[startsWith(one_hot_feats, 'lgnw')], # 1 constraint voor elk lijstelement
                          one_hot_feats[startsWith(one_hot_feats, 'fkg')],  # lgnw's moeten in het eerste lijstelement
                          one_hot_feats[startsWith(one_hot_feats, 'pdkg')],
                          one_hot_feats[startsWith(one_hot_feats, 'sdkg')],
                          one_hot_feats[startsWith(one_hot_feats, 'lgnw')],
                          one_hot_feats[startsWith(one_hot_feats, 'hkg')],
                          one_hot_feats[startsWith(one_hot_feats, 'regsom')],
                          one_hot_feats[startsWith(one_hot_feats, 'mhk')],
                          one_hot_feats[startsWith(one_hot_feats, 'fdg')],
                          one_hot_feats[startsWith(one_hot_feats, 'mvv')],
